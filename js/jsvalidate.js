...
var custom_validators = {
	number: {
		...
		defaultMessage: "Este campo debe tener un valor numérico.",
		regExp: /^[-]?\d+(\.\d+)?$/
	},
	digits: {
		className: "jsvalidate_digits",
		defaultMessage: "Sólo puede contener números.",
		regExp: /^[-]?\d+(\.\d+)?$/
	},
	email: {
		className: "jsvalidate_email",
		defaultMessage: "Dirección de correo electrónico inválida.",
	...
	alpha: {
		...
		defaultMessage: "Solo debe contener letras.",
		regExp: /^[a-zA-z\s]+$/
	},
	alphanum: {
		className: "jsvalidate_alphanum",
		defaultMessage: "Solo debe contener letras y números.",
		regExp: /^[a-zA-Z0-9]+$/
	}
};
...
var js_validators = {
	...
	filetypes: {
		defaultMessage: "Solo archivos: jpg"
	}
};
